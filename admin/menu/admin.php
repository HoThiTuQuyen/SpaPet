    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
            ...
            <!-- <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="index.php?page=don_dv_spa" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Đơn dịch vụ</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.php?page=ngay_gio" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Giờ</p>
                        </p>
                    </a>
                ...
                <li class="nav-item">
                    <a href="index.php?page=lich_spa" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Lịch Spa thú cưng</p>
                        </p>
                    </a>
                </li>
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="index.php?page=phieu_nhap_kho" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Nhập kho</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.php?page=phieu_xuat_kho" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Xuất kho</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.php?page=ton_kho" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Tồn kho</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.php?page=nha_cung_cap" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Nhà cung cấp</p>
                        </p>
                    </a>
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="index.php?page=dichvu" class="nav-link ">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Dịch vụ</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="index.php?page=loaidichvu" class="nav-link ">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Loại dịch vụ</p>
                    </a>
                </li>
