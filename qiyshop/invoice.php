...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="shortcut icon" href="../admin/assets1/img/logos/logo-new2.png" type="image/x-icon">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="invoice-logo">
                                            <!-- logo started -->
                                            <div class="logo">
                                                <img src="../admin/assets1/img/logos/logo-new2.png"
                                    ...
                                    <table class="table mb-0 table-striped invoice-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr">
                                                ...
                                                <td class="text-center">12000 đ</td>
                                                <td class="text-end">0329329329 đ</td>
                                            </tr>
